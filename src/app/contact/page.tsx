                    ...
                    <div className="w-full max-w-5xl mx-auto">
                        ...
                        >
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12 mb-2">
                                ...
                                <div className="p-8 md:p-10 bg-white/80 backdrop-blur-md shadow-lg">
                                    ...
                                    <div className="space-y-6">
                                        <div className="flex items-center space-x-3 group">
                                            <div className="w-10 h-10 bg-gradient-to-br from-accentColor/10 to-transparent
                                        ...
                                        <div className="flex gap-4">
                                            {[FaSquareInstagram, FaTelegram, FaVk].map((Icon, index) => (
                                                <button 
                                                    ...
                                                    className="w-12 h-12 bg-gradient-to-br from-accentColor/10 to-transparent
                                ...
                                <div className="p-8 md:p-10 bg-white/80 backdrop-blur-md shadow-lg">
                                    ...
                                    <form className="space-y-6">
                                        ...
                                        <button
                                            type="submit"
                                            className="w-full px-8 py-4 bg-accentColor text-white
